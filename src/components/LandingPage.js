...
export default function LandingPage(props) {
       ...
       console.log("render")
        function routeToUpload(){
                setPressed(1)
                setTimeout(()=>{history.push("/upload")},800)
        }
                ...
                <div className="container1">
                        <div id="left-title">
                                ...
                                <p>The quickiest and easiest way to share and download files</p>
                                  ...
                                  <button id="getStarted" onClick={()=>history.push("/upload")}>Get started</button>
                          ...
                          <div id="right-container">
                                  <div className="home-login-card">
                                          {loginCard && (
                                                  <Login login={setLoginCard}/>
                                          )}
                                          {!loginCard && (
                                                  <Signup login={setLoginCard}/>
                                          )}
        ...
        <div className="description-header">
                        ...
                        <p>Add more info such as a description or <OverlayTrigger placement="right"  overlay={renderTooltip}><span>password</span></OverlayTrigger>
        ...
        <div className="upload-header">
                <button className="start-uploading-button" pressed={pressed} onClick={routeToUpload}>Start Uploading!</button>
        </div>
